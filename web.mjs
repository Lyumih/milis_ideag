...
;
	($.$milis_ideag_app) = class $milis_ideag_app extends ($.$mol_book2) {
		Theme(){
		...
		New_idea(){
			...
			(obj.value) = (next) => ((this.new_idea(next)));
			return obj;
		}
		add_idea(){
			return null;
		...
		Add_idea_button(){
			...
			(obj.title) = () => ("+");
			(obj.click) = () => ((this.add_idea()));
			return obj;
		}
		Add_idea_labeler(){
			const obj = new this.$.$mol_labeler();
			(obj.title) = () => ("Добавить идею");
			(obj.content) = () => ([(this.New_idea()), (this.Add_idea_button())]);
			return obj;
		}
		idea_list(){
			return [];
	...
	($mol_mem(($.$milis_ideag_app.prototype), "new_idea"));
	($mol_mem(($.$milis_ideag_app.prototype), "New_idea"));
	($mol_mem(($.$milis_ideag_app.prototype), "Add_idea_button"));
	($mol_mem(($.$milis_ideag_app.prototype), "Add_idea_labeler"));
	($mol_mem(($.$milis_ideag_app.prototype), "Idea_filters"));
	($mol_mem(($.$milis_ideag_app.prototype), "Ideas_page"));
	($mol_mem(($.$milis_ideag_app.prototype), "Table"));
	($mol_mem(($.$milis_ideag_app.prototype), "Covering_page"));
...
(function ($) {
    var $$;
    (function ($$) {
        class $milis_ideag_app extends $.$milis_ideag_app {
            ideas() {
        ...
        __decorate([
            $milis_log
        ], $milis_ideag_app.prototype, "ideas", null);
        $$.$milis_ideag_app = $milis_ideag_app;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
