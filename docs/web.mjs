...
;
	($.$milis_ideag_logo_demo) = class $milis_ideag_logo_demo extends ($.$mol_example_small) {
		Logo(){
	...
	($mol_mem(($.$milis_ideag_logo_demo.prototype), "Logo"));
...
;
	($.$milis_ideag_button_demo) = class $milis_ideag_button_demo extends ($.$mol_example_small) {
		Login(){
	...
	($mol_mem(($.$milis_ideag_button_demo.prototype), "Login"));
	($mol_mem(($.$milis_ideag_button_demo.prototype), "Logout"));
...
;
	($.$milis_ideag_docs) = class $milis_ideag_docs extends ($.$mol_app_demo) {
		menu_title(){
			return "Демонстрации";
		}
		source_prefix(){
			return "https://github.com/Lyumih/milis_ideag/tree/master/";
		}
		sources_uri(){
			return "https://github.com/Lyumih/milis_ideag/";
		}
	};
